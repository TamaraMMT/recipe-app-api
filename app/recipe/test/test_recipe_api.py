...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_filter_by_ingredients(self):
        ...
        recipe2 = create_recipe(user=self.user, title='Chicken with rice')
        ingredient1 = Ingredient.objects.create(user=self.user, name='Orion')
